  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        ...
        description="Gérez les propriétaires gérant leurs biens eux-mêmes."
      />
        ...
        <div className="animate-pulse flex flex-col">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex items-center gap-4 py-5 px-4 border-b border-slate-50 last:border-0">
              ...
              <div className="flex-1 hidden md:flex flex-col gap-2 items-start">
                <div className="w-24 h-6 bg-slate-200 rounded-full"></div>
                <div className="w-16 h-6 bg-slate-200 rounded-full mt-1"></div>
              </div>
